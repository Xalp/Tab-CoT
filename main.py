...
def parse_arguments():
    ...
    parser.add_argument(
        "--model", type=str, default="gpt3", choices=["gpt3", "gpt3-medium", "gpt3-large", "gpt3-xl", "code", "code-xl", "chatgpt"], help="model used for decoding. Note that 'gpt3' are the smallest models."
    )
